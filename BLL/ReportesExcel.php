...
function ExportarExcelTotalHerramientas(){
    ...
    $x=0;
        ...
        $x=100;
    switch ($opc) {
        case "0":$result = $bdHerramientas->listarTotalHerramientas(); $x=0;
            break;
        case "1":$result = $bdHerramientas->FiltrosHerramientas1();$x=1;
            break;
        case "2":$result = $bdHerramientas->FiltrosHerramientas2();$x=1;
            break;
        case "3":$result = $bdHerramientas->FiltrosHerramientas3();$x=1;
            break;
