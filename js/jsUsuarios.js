...
function CambioPassword(){
   ...
   if(passActual == passUsuario){
       if(nuevoPass == confirmarPass){
           $.ajax({
               data : {"nuevoPass" : confirmarPass,"ID_Usuario":$("#ID_UsuarioCuenta").html()},
               url : "..//BLL/Usuario.php?opc=cambioPass",
               type :"POST",
               success: function (respuesta) {
                    if (respuesta== 1) {
                                $("#modalheaderCambioPass").addClass("mensajeCorrecto");
                               $("#TituloCambioPass").html("<strong>Contraseña Actualizada Correctamente</strong>");
                           ...
                           $("#modalheaderCambioPass").addClass("mensajeError");
                               $("#TituloCambioPass").html("<strong>Ocurrio Un Error </strong>");
                                   setTimeout(function () {
                                $("#modalheaderCambioPass").removeClass("mensajeCorrecto");
                                $("#modalheaderCambioPass").removeClass("mensajeError");
                                $("#TituloCambioPass").html("Cambiar Contraseña");
       ...
       $("#modalheaderCambioPass").addClass("mensajeError");
       $("#TituloCambioPass").html("<strong>Contraseñas no Coinciden</strong>");
           setTimeout(function () {
        $("#modalheaderCambioPass").removeClass("mensajeCorrecto");
        $("#modalheaderCambioPass").removeClass("mensajeError");
        $("#TituloCambioPass").html("Cambiar Contraseña");
       ...
       $("#modalheaderCambioPass").addClass("mensajeError");
       $("#TituloCambioPass").html("<strong>La Contraseña NO coincide con la actual</strong>");
           setTimeout(function () {
        $("#modalheaderCambioPass").removeClass("mensajeCorrecto");
        $("#modalheaderCambioPass").removeClass("mensajeError");
        $("#TituloCambioPass").html("Cambiar Contraseña");
